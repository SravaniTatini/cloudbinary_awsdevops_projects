  ...
  <body class="">
    <div class="wrapper">
      ...
      <div class="message">
        ...
        <div class="text">
          <h1>Hello Friends!</h1>
          <h2>This web application is created by SRAVANI.</h2>
        </div>
      </div>
    </div>

    <footer>
      <p class="footer-contents">Designed and developed with <a href="https://aws.amazon.com/careers/devtools-jobs/">♥</a> by SRAVANI.</p>
    </footer>
